...
const generatedProducts = teams.filter((team) => jerseyByTeam[team.id]).flatMap((team, teamIndex) => [
  {
    ...
    teamId: team.id,
    category: 'Jerseys',
    name: team.id === 'brazil' ? `${team.name} Maillot extérieur 2026` : `${team.name} Maillot domicile 2026`,
    price: 89,
    oldPrice: 110,
    image: buildJerseyGallery(team.id)[0],
    gallery: buildJerseyGallery(team.id),
    badge: teamIndex % 3 === 0 ? 'Meilleure vente' : 'Nouveau',
    color: team.colors[0],
  },
  {
    id: `${team.id}-away`,
    ...
    category: 'Jerseys',
    name: team.id === 'france'
      ? `${team.name} Maillot extérieur 2026`
      : team.id === 'brazil'
        ? `${team.name} Hoodie jaune de match 2026`
        : `${team.name} Maillot supporter 2026`,
    price: 84,
  ...
  ...(team.id === 'france'
    ...
    : team.id === 'brazil'
      ? [{
        ...
        teamId: team.id,
        category: 'Jerseys',
        name: `${team.name} Hoodie de match 2026`,
        price: 94,
    ...
    : [
      {
        ...
        teamId: team.id,
        category: 'Sandals',
        name: `${team.name} Claquettes écusson`,
        price: 39,
      ...
      },
      {
        ...
        teamId: team.id,
        category: 'Tattoos',
        name: `${team.name} Tatouages jour de match`,
        price: 12,
        ...
        badge: teamIndex % 4 === 0 ? 'Pack fan' : null,
        color: team.colors[0],
      },
      {
        id: `${team.id}-shoes`,
        ...
        badge: teamIndex % 2 === 0 ? 'Édition limitée' : null,
        color: team.colors[0],
      },
    ]),
]);
